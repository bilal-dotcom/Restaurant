      ...
      " has been uploaded<br>";
        ...
        echo "<br>There was an error uploading the file, please try again!";
				...
				if (isset($_POST["entrerrecette"]))
				{
					...
					{
						echo"Veuillez entrer l'id d'un membre";
					}
					else{
					...
					VALUES
					('$nom','$ingredient','$prepa','$nb','$cout','$date','$photo','$idmembre')") or die ("Erreur d'insertion");
		
		$nbre= mysqli_affected_rows($connect);
			if ($nbre>0)
			{
				
				echo "<br>L'insertion de  $nom  a été effectué";
				
			}
			else
			{
				echo "<br>Erreur d'insertion de la recette";
			}
					}
				}
